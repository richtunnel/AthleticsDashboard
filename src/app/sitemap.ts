...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: Array<{ path: string; changeFrequency?: MetadataRoute.Sitemap[number]["changeFrequency"]; priority?: number }> = [
    ...
    { path: "/careers/athletic-director", changeFrequency: "monthly", priority: 0.6 },
    { path: "/careers/educational-sales-consultant", changeFrequency: "monthly", priority: 0.6 },
    { path: "/careers/ui-ux-designer", changeFrequency: "monthly", priority: 0.6 },
    { path: "/members", changeFrequency: "monthly", priority: 0.5 },
