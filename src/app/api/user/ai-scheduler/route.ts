...
export async function GET() {
  try {
    ...
    return NextResponse.json({
      success: true,
      aiSchedulerEnabled: user.aiSchedulerEnabled,
    });
  } catch (error) {
    console.error("Error fetching AI scheduler setting:", error);
...
export async function PATCH(request: NextRequest) {
  try {
    ...
    console.error("Error updating AI scheduler setting:", error);
