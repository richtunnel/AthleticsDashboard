    ...
    <>
      ...
      <Box sx={{ maxWidth: 800, mx: "auto", p: 3 }}>
        ...
        <Typography variant="body1" paragraph>
          At Opletics, we are committed to protecting your privacy and ensuring the security of your data. This Privacy Policy explains how we collect, use, disclose, and protect your information when
        ...
        <Typography variant="body1" paragraph>
          ...
          <ul>
            <li>Provide and improve the Opletics services.</li>
        ...
        <Typography variant="body1" paragraph>
          We may update this Privacy Policy. Significant changes will be communicated via email or through the platform. Continued use of the Opletics after changes constitutes acceptance of the new
          policy.
        </Typography>
