  ...
  return (
    ...
    >
      ...
      <Stack direction="row" alignItems="center" gap={0.5} sx={{ mb: 0.3 }}>
        <Box sx={{ color: c.color, display: "flex", alignItems: "center", flexShrink: 0 }}>
          {c.icon}
        </Box>
...
const PRIMARY_TIPS: Tip[] = [
  {
    ...
    callouts: [
      { type: "note", text: "Game Center includes pre-built column filters so you can slice and sort your schedule the moment it's imported." },
    ],
  ...
  },
  {
    ...
    tag: "Game Center",
    body: "After importing, use the Change View button above the table in Game Center to switch to a structured layout. Drag columns, apply filters, and sort by sport, date, or level to match exactly how you think.",
    callouts: [
      { type: "learning", text: "Column visibility is saved per-session so your layout stays consistent every time you return." },
    ],
    href: "/dashboard/games",
  ...
  },
  {
    ...
    callouts: [
      { type: "note", text: "No copy-pasting or manual formatting needed. The platform handles layout and distribution automatically." },
    ],
  ...
  },
  {
    ...
    tag: "Email Manager",
    body: "Your school email is automatically applied as the reply-to address on every outgoing email. Add your school name, logo, and contact details to the signature — the system takes care of delivery and formatting.",
    callouts: [
  ...
  },
  {
    ...
    callouts: [
      { type: "important", text: "Your CSV must include both a date column and a time column for sync to work. Missing times will result in all-day events without reminders." },
    ],
  ...
  },
  {
    ...
    callouts: [
      { type: "learning", text: "Your district is shown first by default. Add your district in Settings → School Details to enable this filtering." },
    ],
    href: "/schedule-board",
  ...
  },
  {
    ...
    callouts: [
      { type: "learning", text: 'Try: "Find open Fridays in November for Varsity Football." The AI reads your live schedule data.' },
    ],
    href: "/dashboard/games",
    cta: "Try It →",
  },
...
const MORE_TIPS: Tip[] = [
  {
    ...
    callouts: [
      { type: "note", text: "Parents never see your administrative data — they only see the public-facing game schedule you share." },
    ],
  ...
  },
  {
    ...
    callouts: [
      { type: "important", text: "Enhanced Travel Time requires Google Maps to be connected under Settings → Calendars for real-time route data." },
    ],
  ...
  },
  {
    ...
    callouts: [
      { type: "note", text: "Collaborator activity is tracked separately so you always know who changed what." },
    ],
    href: "/dashboard/settings",
  ...
  },
  {
    ...
    callouts: [
      { type: "learning", text: "Announcements go straight to connected parents — use them for urgent changes like cancellations or location updates. Community posts are visible to your broader network." },
    ],
      ...
      {!showMore ? (
        <Box sx={{ textAlign: "center", mt: 4 }}>
          <Button
            ...
            sx={{ textTransform: "none", fontWeight: 600, borderRadius: 3, px: 3 }}
          >
            See More Features
          </Button>
