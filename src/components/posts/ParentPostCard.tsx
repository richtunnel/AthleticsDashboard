...
import PostEngagement, { type EngagementState } from "./PostEngagement";
import CommentSection from "./CommentSection";
import type { PostAuthor, PostImageData } from "./PostCard";
...
export default function ParentPostCard({ post, currentParentId }: ParentPostCardProps) {
  ...
  const engagementInitial: EngagementState = {
  ...
  return (
    <Card
      sx={{
        ...
        "&:hover": {
          boxShadow: theme.palette.mode === "dark" ? "0 4px 12px rgba(0,0,0,0.5)" : "0 4px 12px rgba(0,0,0,0.12)",
        },
      }}
    >
      <CardContent sx={{ p: 2.5, "&:last-child": { pb: 2.5 } }}>
        ...
        <PostEngagement
          postId={post.id}
          initial={{ ...engagementInitial, commentCount }}
