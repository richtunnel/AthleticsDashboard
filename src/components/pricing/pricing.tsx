import { Box, HStack, Heading, Icon, SimpleGrid, StackProps, Text, VStack } from "@chakra-ui/react";
      ...
      <Box zIndex="2" pos="relative">
        ...
        <SimpleGrid columns={[1, null, 3]} spacing={4}>
          {plans?.map((plan) => (
            ...
            >
              <PricingFeatures>{plan.features.map((feature, i) => (feature ? <PricingFeature key={i} {...feature} /> : <br key={i} />))}</PricingFeatures>
