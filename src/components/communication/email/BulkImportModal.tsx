          ...
          {(mode === "idle" || mode === "error") && (
            <>
              <Alert severity="info" icon={<InfoOutlinedIcon />} sx={{ fontSize: "0.8rem" }}>
                <strong>CSV or TXT files only.</strong> Upload a file with an <em>Email</em> column, or paste email addresses directly into the text box below. Duplicates are automatically skipped.
              </Alert>
